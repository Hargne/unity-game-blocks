...
namespace GameBlocks.References
{
    ...
    [CustomPropertyDrawer(typeof(MinMaxFloatReference))]
    public class MinMaxFloatReferenceDrawer : ReferenceDrawer {
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			return base.GetPropertyHeight(property, label) + 80f;
		}
    }
}